...
// This file contains the actual configuration with your Gemini API key
...
module.exports = {
  ...
  // Gemini API Configuration (Your API key is configured here)
  gemini: {
    apiKey: 'AIzaSyD55mHbcwKxjyfia_i1Vvh1v2E2ChGayAw',
